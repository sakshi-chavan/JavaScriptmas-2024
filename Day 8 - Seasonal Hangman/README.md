...
<ul><li>If the player guesses the entire word, they win! </li></ul>
    <ol><li> Any removed parts of the snowman are reinstated.</li>
    <li>The snowman gets sunglasses</li>
    <li>The message "You Win!" is displayed in the "guess-container" div.</li></ol>
<ul><li>If the player guesses wrong 6 times: </li>
    <ol><li>only a puddle remains.</li>
    <li> The message "You Lose!" is displayed in the "guess-container" div.</li></ol>
</p>
